...
# Iniitalizing random weights for all nodes of the neural network
...
# Print function to print log for each iteration
...
if __name__ == "__main__":
    ...
    w1, w2 = train(data.X_train, data.Y_train,
                   ...
                   n_hidden_nodes=200, epochs=5, batch_size=20000, lr=0.01)
